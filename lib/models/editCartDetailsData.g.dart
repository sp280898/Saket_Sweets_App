...
part of 'editCartDetailsData.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

EditCartDetailsData _$EditCartDetailsDataFromJson(Map<String, dynamic> json) =>
    EditCartDetailsData()
      ..id = json['id'] as num?
...
Map<String, dynamic> _$EditCartDetailsDataToJson(
        EditCartDetailsData instance) =>
    <String, dynamic>{
      'id': instance.id,
